...
struct ModelConfiguration: Identifiable, Codable, Equatable, Hashable {
    ...
    static let bonsai8B2bit = ModelConfiguration(
        ...
        license: "apache-2.0",
        description: "Fully private, on-device. An 8-billion-parameter model in a 2.3 GB download — trained-ternary weights give it the depth of a much larger model at a fraction of the size, and it generates about as fast as the 3B models. The deepest reasoner in the curated tier and the strongest on Hal's Five-Maxim tests. 2.3 GB download.",
        isDownloaded: false,
        localPath: nil,
