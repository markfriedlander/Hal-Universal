...
- **Scripted prompts.** The arc is fixed across all runs for cross-depth
  comparability. SC's directive was "improvised reactively" — that
  pass is deferred to next session and would be the realism check.
